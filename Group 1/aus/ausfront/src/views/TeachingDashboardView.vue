    ...
    uploadFile(){
      ...
      // Continue with saving audio information to the backend
        ...
        .then(response => {
          ...
          this.showModal = false;
          this.getAllAudio();  // Assuming you have a method to fetch all audio after adding a new one
...
.remove-button {
  ...
  cursor: pointer;
  border-radius: 5px;
  margin-left: 10px; /* 调整按钮之间的距离，也可以直接设置 margin-left */
}
